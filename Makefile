...
CRYPTOLGEN_EXE := ./dist/build/cryptolgen/cryptolgen${EXE_EXT}
...
CRYPTOL_SRC := \
  $(shell find src cryptol generator \
...
${CRYPTOL_EXE} ${CRYPTOLGEN_EXE}: $(CRYPTOL_SRC) src/GitRev.hs dist/setup-config
	$(CABAL_BUILD)
